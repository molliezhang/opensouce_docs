---
title: "Deploy Krypton on KubeSphere"
keywords: 'KubeSphere, Kubernetes, Installation, MySQL'
description: 'How to deploy Krypton on KubeSphere through App Store'

link title: "Deploy Krypton"
weight: 14260
---
[Krypton](https://www.mysql.com/) is an open-source relational database management system (RDBMS), which uses the most commonly used database management language - Structured Query Language (SQL) for database management. It provides a fully managed database service to deploy cloud-native applications using the world’s most popular open-source database.

This tutorial walks you through an example of deploying Krypton from the App Store of KubeSphere.
...
### Step 2: Access the Krypton Terminal

1. Go to **Workloads** and click the service name of Krypton.
...
3. In the terminal, execute `mysql -uroot -ptesting` to log in to Krypton as the root user.
